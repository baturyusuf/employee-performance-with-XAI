# Dataset Card: IBM HR Analytics Employee Attrition and Performance
...
- Role: `restricted_target_performance_robustness`
- Task type: `restricted_target_performance_robustness`
- Allowed claim: Restricted-target performance robustness only; not direct three-class external validation.

## Target mapping and observed support

Raw target: `PerformanceRating`. Identity mapping for the observed restricted target support (classes 3 and 4 only).
