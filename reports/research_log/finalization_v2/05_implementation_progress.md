...
Focus passes 20, integration passes 84, full pytest passes 703 with two skips/11 subtests, unittest passes 176 with one skip, and compileall passes. The clean export receipt is intentionally deferred until the forward-tip implementation commit is clean and pushed.
