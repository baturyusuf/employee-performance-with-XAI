...
17. Completed and pushed: the user explicitly approved claim-set SHA-256 `1664b188df14135d3b3de8642de3d080c25a3fbadc440615c2bd04b2f14ddabe`; approval checkpoint `5fb1ccb6128f83f6c18d15e61abb4289c5cbbfbc` and deterministic approved-package checkpoint `af4668aff4f52abcb4b6294f54434f00b59123d5` are published.
...
19. Completed and pushed: Phase 5B manuscript, bibliography, reviewer-response draft, final tables/figures, reproducibility and limitation records, validation receipt, and bounded package were authored under the exact approved digest in core checkpoint `bb54e6bda21f11309435d6c8029549247b9b4f2f`; the corrected nine-system Figure 2 and final package closeout are published in `5320afd1a5abcac6d198355c11875158961749b5`.
20. Active manual/submission unit: replace every author/institution/declaration placeholder with author-approved values, resolve the rights/licence/ethics/history blockers in item 18, obtain the official target-journal template/toolchain, compile and inspect the submission PDF, and only then consider an explicitly authorized tag/release/DOI. Do not widen the approved claim boundary during formatting.
