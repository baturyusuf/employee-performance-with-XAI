...
13. In progress: Phase 3A exact run `phase3a_v3_20260907T141213Z_f6e6a0a` completed all 2,300 XGBoost and 150 baseline fits and passed independent closed-world, fold, selection, baseline, calibration, metric, per-class, confusion, and design-comparison recomputation. Next checkpoint the validator/exporter, publish and revalidate only the 14-file compact non-row-level evidence, then proceed to Phase 3B data quality and the literature/provenance/deliverable phases in `../major_revision_v3/PLAN.md`.
