...
- Unit 2G implementation and publication-contract checkpoint: `ae5cf5a` on `finalization/leakage-aware-v2`; the production stage-validation run and complete canonical package are still pending.
