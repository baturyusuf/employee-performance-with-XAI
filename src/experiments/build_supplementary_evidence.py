"""Fail-closed entry point for the canonical supplementary evidence scope."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the supplementary research evidence package.")
